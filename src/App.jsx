...
export default function App() {
  ...
  return (
    <AppCtx.Provider value={{ navigate, team, setTeam, selectedAdminTeam, setSelectedAdminTeam, currentLocationId, setCurrentLocationId, puzzleData, setPuzzleData, hintLocationId, setHintLocationId, gameCompleted, setGameCompleted }}>
      <FontLink />
      <Screen />
    </AppCtx.Provider>
  );
